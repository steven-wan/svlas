...
(
    ...
    `trigger_type`          int(2)       DEFAULT NULL COMMENT '触发器类型： 0 - simple  1 - cron',
    `corn_expression` varchar(50)      NOT NULL COMMENT 'corn 表达式',
    `simple_interval_time` int(2)      NOT NULL COMMENT 'simple 触发器时间间隔',
    `simple_interval_time_type` int(2)      NOT NULL COMMENT 'simple 触发器时间间隔类型：0 - 无限重复 1 - seconds 2 - milliseconds  3 - minutes  4 - hours',
